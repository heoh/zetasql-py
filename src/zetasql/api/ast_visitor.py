...
Provides a base visitor class for traversing ASTNode hierarchies with:
...
from zetasql.types.proto_model import ASTNode, ProtoModel
...
class ASTNodeVisitor:
    ...
    def descend(self, node: ASTNode) -> None:
        ...
        Args:
            node: The ASTNode whose children should be visited
        """
        if node is None:
            return
