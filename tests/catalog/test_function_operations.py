...
class TestCatalogFunctionAdd:
    ...
    def test_add_scalar_function(self):
        ...
        function = (
            ...
            .add_signature(
                SignatureBuilder().add_argument(TypeKind.TYPE_STRING).set_return_type(TypeKind.TYPE_INT64).build()
            )
            .build()
        )
    ...
    def test_add_function_with_multiple_signatures(self):
        ...
        function = (
            ...
            .add_signature(
                SignatureBuilder().add_argument(TypeKind.TYPE_INT64).set_return_type(TypeKind.TYPE_STRING).build()
            )
            .build()
        )
