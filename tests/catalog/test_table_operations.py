...
class TestCatalogTableAdd:
    ...
    def test_add_multiple_tables(self):
        ...
        catalog = CatalogBuilder("db").add_table(t1).add_table(t2).add_table(t3).build()
...
class TestCatalogTableRetrieval:
    ...
    def test_get_table_list_method(self):
        ...
        catalog = CatalogBuilder("db").add_table(t1).add_table(t2).build()
