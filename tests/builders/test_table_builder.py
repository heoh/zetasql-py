...
class TestTableBuilder:
    ...
    def test_table_with_serialization_id(self):
        ...
        table = TableBuilder("products", serialization_id=42).add_column("product_id", TypeKind.TYPE_INT64).build()
    ...
    def test_table_with_array_column(self):
        ...
        array_type = TypeFactory.create_array_type(TypeFactory.create_simple_type(TypeKind.TYPE_STRING))

        table = TableBuilder("items").add_column("item_id", TypeKind.TYPE_INT64).add_column("tags", array_type).build()
    ...
    def test_table_with_nested_array(self):
        ...
        nested_array = TypeFactory.create_array_type(
            TypeFactory.create_array_type(TypeFactory.create_simple_type(TypeKind.TYPE_INT64))
        )

        table = TableBuilder("matrix").add_column("id", TypeKind.TYPE_INT64).add_column("data", nested_array).build()
    ...
    def test_value_table(self):
        ...
        table = TableBuilder("value_table").add_column("value", TypeKind.TYPE_STRING).as_value_table().build()
